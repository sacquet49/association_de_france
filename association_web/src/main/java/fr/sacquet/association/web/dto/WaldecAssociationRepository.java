...
public interface WaldecAssociationRepository extends CrudRepository<WaldecAssociation, String> {
    ...
    @Query(value = "SELECT new fr.sacquet.association.web.bean.WaldecAssociationStat(SUBSTRING(wa.adrsCodepostal,1,2), count(wa)) " +
    ...
    List<WaldecAssociationStat> statWaldecAssociation();
}
